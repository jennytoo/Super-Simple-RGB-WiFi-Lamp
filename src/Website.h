...
void sendStaticBody(ESP8266WebServer &restServer) {
  ...
  restServer.sendContent_P(PSTR("            }\n"));
  restServer.sendContent_P(PSTR("            if (\"Fireflies\" in jsonMessage) {\n"));
  restServer.sendContent_P(PSTR("                // console.log(\"Found Fireflies Message\")\n"));
  restServer.sendContent_P(PSTR("                handleNightRiderMessage(jsonMessage[\"Fireflies\"])\n"));
  restServer.sendContent_P(PSTR("            }\n"));
  ...
  restServer.sendContent_P(PSTR("                    </li>\n"));
  restServer.sendContent_P(PSTR("                    <li id=\"firefliesTabNavItem\" class=\"nav-item\">\n"));
  restServer.sendContent_P(PSTR("                        <a class=\"nav-link\" data-toggle=\"tab\" href=\"#Fireflies\">Fireflies</a>\n"));
  restServer.sendContent_P(PSTR("                    </li>\n"));
  ...
  restServer.sendContent_P(PSTR("                    });\n"));
  restServer.sendContent_P(PSTR("                    $(\"#firefliesTabNavItem\").click(function () {\n"));
  restServer.sendContent_P(PSTR("                        sendMessage({\"Mode\":\"Fireflies\"})\n"));
  restServer.sendContent_P(PSTR("                    });\n"));
  restServer.sendContent_P(PSTR("                </script>\n"));
  ...
  restServer.sendContent_P(PSTR("            <button id=\"firefliesButton\" type=\"submit\" class=\"col mb-2 mx-2 btn btn-lg btn-outline-light\">Fireflies</button>\n"));
  ...
  restServer.sendContent_P(PSTR("                    sendMessage({\"Mode\":\"Night Rider\"})\n"));
  restServer.sendContent_P(PSTR("                });\n"));
  restServer.sendContent_P(PSTR("                $(\"#firefliesButton\").click(function () {\n"));
  restServer.sendContent_P(PSTR("                    $('#navbarHeader a[href=\"#Fireflies\"]').tab('show')\n"));
  restServer.sendContent_P(PSTR("                    sendMessage({\"Mode\":\"Fireflies\"})\n"));
  restServer.sendContent_P(PSTR("                });\n"));
  ...
  restServer.sendContent_P(PSTR("                    }\n"));
  restServer.sendContent_P(PSTR("\n"));
  restServer.sendContent_P(PSTR("                    if (Date.now() - rainbowDebunce > 50) {\n"));
  ...
  restServer.sendContent_P(PSTR("        </div>\n"));
  restServer.sendContent_P(PSTR("        <div id=\"Fireflies\" class=\"container pb-5 tab-pane fade\">\n"));
  restServer.sendContent_P(PSTR("            <h2>Fireflies Mode</h2>\n"));
  restServer.sendContent_P(PSTR("            <p>Here come real stars to fill the upper skies,\n"));
  restServer.sendContent_P(PSTR("               And here on earth come emulating flies,\n"));
  restServer.sendContent_P(PSTR("               That though they never equal stars in size,\n"));
  restServer.sendContent_P(PSTR("               (And they were never really stars at heart)\n"));
  restServer.sendContent_P(PSTR("               Achieve at times a very star-like start.\n"));
  restServer.sendContent_P(PSTR("               Only, of course, they can't sustain the part.\n"));
  restServer.sendContent_P(PSTR("               -- Robert Frost, \"Fireflies in the Garden\"</p>\n"));
  restServer.sendContent_P(PSTR("            <div>\n"));
  restServer.sendContent_P(PSTR("                <label for=\"firefliesHue\">Hue: <span id=\"firefliesHueLabel\">0</span> Degrees</label>\n"));
  restServer.sendContent_P(PSTR("                <input id=\"firefliesHue\" type=\"range\" min=\"0\" max=\"359\" step=\"1\" value=\"0\" class=\"form-control-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <div>\n"));
  restServer.sendContent_P(PSTR("                <label for=\"firefliesBrightness\">Brightness: <span id=\"firefliesBrightnessLabel\">100</span>%</label>\n"));
  restServer.sendContent_P(PSTR("                <input id=\"firefliesBrightness\" type=\"range\" min=\"0\" max=\"100\" step=\"1\" value=\"100\" class=\"form-control-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <div>\n"));
  restServer.sendContent_P(PSTR("                <label for=\"firefliesMinimumFlashDelay\">Minimum Flash Delay: <span id=\"firefliesMinimumFlashDelayLabel\">1000</span> milliseconds</label>\n"));
  restServer.sendContent_P(PSTR("                <input id=\"firefliesMinimumFlashDelay\" type=\"range\" min=\"0\" max=\"30000\" step=\"100\" value=\"1000\" class=\"form-control-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <div>\n"));
  restServer.sendContent_P(PSTR("                <label for=\"firefliesMaximumFlashDelay\">Maximum Flash Delay: <span id=\"firefliesMaximumFlashDelayLabel\">5000</span> milliseconds</label>\n"));
  restServer.sendContent_P(PSTR("                <input id=\"firefliesMaximumFlashDelay\" type=\"range\" min=\"0\" max=\"30000\" step=\"100\" value=\"5000\" class=\"form-control-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <div>\n"));
  restServer.sendContent_P(PSTR("                <label for=\"firefliesFlashLength\">Flash Length: <span id=\"firefliesFlashLengthLabel\">500</span> milliseconds</label>\n"));
  restServer.sendContent_P(PSTR("                <input id=\"firefliesFlashLength\" type=\"range\" min=\"0\" max=\"15000\" step=\"50\" value=\"500\" class=\"form-control-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <script>\n"));
  restServer.sendContent_P(PSTR("                var firefliesDebunce = Date.now()\n"));
  restServer.sendContent_P(PSTR("\n"));
  restServer.sendContent_P(PSTR("                $(\"#firefliesHue\").on(\"input\", function () {\n"));
  restServer.sendContent_P(PSTR("                    onfirefliesEvent()\n"));
  restServer.sendContent_P(PSTR("                });\n"));
  restServer.sendContent_P(PSTR("                $(\"#firefliesHue\").on(\"change\", function () {\n"));
  restServer.sendContent_P(PSTR("                    onfirefliesEvent()\n"));
  restServer.sendContent_P(PSTR("                });\n"));
  restServer.sendContent_P(PSTR("                $(\"#firefliesBrightness\").on(\"input\", function () {\n"));
  restServer.sendContent_P(PSTR("                    onfirefliesEvent()\n"));
  restServer.sendContent_P(PSTR("                });\n"));
  restServer.sendContent_P(PSTR("                $(\"#firefliesBrightness\").on(\"change\", function () {\n"));
  restServer.sendContent_P(PSTR("                    onfirefliesEvent()\n"));
  restServer.sendContent_P(PSTR("                });\n"));
  restServer.sendContent_P(PSTR("                $(\"#firefliesMinimumFlashDelay\").on(\"input\", function () {\n"));
  restServer.sendContent_P(PSTR("                    onfirefliesEvent()\n"));
  restServer.sendContent_P(PSTR("                });\n"));
  restServer.sendContent_P(PSTR("                $(\"#firefliesMinimumFlashDelay\").on(\"change\", function () {\n"));
  restServer.sendContent_P(PSTR("                    onfirefliesEvent()\n"));
  restServer.sendContent_P(PSTR("                });\n"));
  restServer.sendContent_P(PSTR("                $(\"#firefliesMaximumFlashDelay\").on(\"input\", function () {\n"));
  restServer.sendContent_P(PSTR("                    onfirefliesEvent()\n"));
  restServer.sendContent_P(PSTR("                });\n"));
  restServer.sendContent_P(PSTR("                $(\"#firefliesMaximumFlashDelay\").on(\"change\", function () {\n"));
  restServer.sendContent_P(PSTR("                    onfirefliesEvent()\n"));
  restServer.sendContent_P(PSTR("                });\n"));
  restServer.sendContent_P(PSTR("                $(\"#firefliesFlashLength\").on(\"input\", function () {\n"));
  restServer.sendContent_P(PSTR("                    onfirefliesEvent()\n"));
  restServer.sendContent_P(PSTR("                });\n"));
  restServer.sendContent_P(PSTR("                $(\"#firefliesFlashLength\").on(\"change\", function () {\n"));
  restServer.sendContent_P(PSTR("                    onfirefliesEvent()\n"));
  restServer.sendContent_P(PSTR("                });\n"));
  restServer.sendContent_P(PSTR("\n"));
  restServer.sendContent_P(PSTR("                function onfirefliesEvent() {\n"));
  restServer.sendContent_P(PSTR("                    let currentHueValue = parseInt($(\"#firefliesHue\").val(), 10)\n"));
  restServer.sendContent_P(PSTR("                    let currentBrightnessValue = parseInt($(\"#firefliesBrightness\").val(), 10)\n"));
  restServer.sendContent_P(PSTR("                    let currentMinimumFlashDelay = parseInt($(\"#firefliesMinimumFlashDelay\").val(), 10)\n"));
  restServer.sendContent_P(PSTR("                    let currentMaximumFlashDelay = parseInt($(\"#firefliesMaximumFlashDelay\").val(), 10)\n"));
  restServer.sendContent_P(PSTR("                    let currentFlashLength = parseInt($(\"#firefliesFlashLength\").val(), 10)\n"));
  restServer.sendContent_P(PSTR("\n"));
  restServer.sendContent_P(PSTR("                    $(\"#firefliesHueLabel\").html(currentHueValue)\n"));
  restServer.sendContent_P(PSTR("                    $(\"#firefliesBrightnessLabel\").html(currentBrightnessValue)\n"));
  restServer.sendContent_P(PSTR("                    $(\"#firefliesMinimumFlashDelayLabel\").html(currentMinimumFlashDelay)\n"));
  restServer.sendContent_P(PSTR("                    $(\"#firefliesMaximumFlashDelayLabel\").html(currentMaximumFlashDelay)\n"));
  restServer.sendContent_P(PSTR("                    $(\"#firefliesFlashLengthLabel\").html(currentFlashLength)\n"));
  restServer.sendContent_P(PSTR("\n"));
  restServer.sendContent_P(PSTR("                    msg = {\n"));
  restServer.sendContent_P(PSTR("                        \"State\" : true,\n"));
  restServer.sendContent_P(PSTR("                        \"Mode\" : \"Fireflies\",\n"));
  restServer.sendContent_P(PSTR("                        \"Fireflies\": {\n"));
  restServer.sendContent_P(PSTR("                            \"Hue\" : Math.round(currentHueValue/359*255),\n"));
  restServer.sendContent_P(PSTR("                            \"Brightness\": Math.round(currentBrightnessValue/100*255),\n"));
  restServer.sendContent_P(PSTR("                            \"MinimumFlashDelay\": currentMinimumFlashDelay,\n"));
  restServer.sendContent_P(PSTR("                            \"MaximumFlashDelay\": currentMaximumFlashDelay,\n"));
  restServer.sendContent_P(PSTR("                            \"FlashLength\": currentFlashLength\n"));
  restServer.sendContent_P(PSTR("                        }\n"));
  restServer.sendContent_P(PSTR("                    }\n"));
  restServer.sendContent_P(PSTR("\n"));
  restServer.sendContent_P(PSTR("                    if (Date.now() - firefliesDebunce > 50) {\n"));
  restServer.sendContent_P(PSTR("                        firefliesDebunce = Date.now()\n"));
  restServer.sendContent_P(PSTR("                        sendMessage(msg)\n"));
  restServer.sendContent_P(PSTR("                    }\n"));
  restServer.sendContent_P(PSTR("                }\n"));
  restServer.sendContent_P(PSTR("            </script>\n"));
